...
EDAM-bioimaging releases are citable with DOIs too, for cases when that is needed. [![10.5281/zenodo.1149730](https://zenodo.org/badge/DOI/10.5281/zenodo.1149730.svg)](https://doi.org/10.5281/zenodo.1149730) [![Join the chat at https://gitter.im/edamontology/edam-bioimaging](https://badges.gitter.im/edamontology/edam-bioimaging.svg)](https://gitter.im/edamontology/edam-bioimaging?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) represents all releases and resolves to the DOI of the last stable release. For the DOI of a particular release of EDAM-bioimaging, please see [/releases](https://github.com/edamontology/edam-bioimaging/tree/main/releases).
